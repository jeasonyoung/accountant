...
public class AppConfig {
	...
	public final static String CONF_LIMIT_DATE = "perf_expires";
	public final static String CONF_REST_HOURS = "pref_hours";
	
	public final static String SAVE_IMAGE_PATH = "save_image_path";
	@SuppressLint("NewApi")
	public final static String DEFAULT_SAVE_IMAGE_PATH = Environment.getExternalStorageDirectory()+ File.separator+ "CHAccountant"+ File.separator+"images"+File.separator;
...
//	private AccessInfo accessInfo = null;
	...
	{
		String code = CyptoUtils.encode("changheng", date);
		set(CONF_LIMIT_DATE,code);
	}
	public void setRestHours(Integer hours)
	{
		String code = CyptoUtils.encode("changheng", String.valueOf(hours));
		set(CONF_REST_HOURS,code);
	}
	public Integer getRestHours()
	{
		String hours = get(CONF_REST_HOURS);
		if(hours != null)
		{
			return Integer.valueOf(CyptoUtils.decode("changheng", hours));
		}
		return null;
	}
	public String getExpires()
	{
		String date = get(CONF_LIMIT_DATE);
		if(date!=null)
		{
			return CyptoUtils.decode("changheng", date);
		}
		return date;
	}
