...
public class QuestionContentDecoder {
	...
	public static String getContent(String content, int random) {
		...
		String base = content.replaceAll(key,
				String.valueOf((char) (64 + random)));
		try {
	...
	public static String encodeContent(String content, int random) {
		String code1 = new String(Base64.encode(content.getBytes(), 0));
		String key = md5Digest(getCode(random));
		return code1.replaceAll(String.valueOf((char) (64 + random)), key);
	}
	public static String decodeContent(String content, int random) {
		String key = md5Digest(getCode(random));
		String base = content.replaceAll(key,
				String.valueOf((char) (64 + random)));
		return new String(Base64.decode(base.getBytes(), 0));
	}
