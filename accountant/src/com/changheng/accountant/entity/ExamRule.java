...
public class ExamRule extends Entity{
	private long _id;
	private String type,ruleId,paperId,title,ruleScoreSet,fullTitle,containQids;
	public String getContainQids2() {
		if(StringUtils.isEmpty(containQids))
			return containQids;
		return ","+containQids+",";
	}
	public String getContainQids()
	{
		return containQids;
	}
	public void setContainQids(String containQids) {
		this.containQids = containQids;
	}
...
//		return ruleQuestionNum;
		...
		return containQids.split(",").length;
	}
	...
	public ExamRule(String ruleId, String paperId, String ruleTitle,String ruleTitleInfo,
			String ruleType,String scoreSet, int questionNum, double scoreForEach, int orderInPaper,String containQids) {
		super();
		this.ruleId = ruleId;
		this.paperId = paperId;
		this.title = ruleTitle;
